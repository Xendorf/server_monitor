...
$sm_lang = array(
	...
	'servers' => array(
        ...
        'error_server_no_response' => 'Nessuna risposta dal server',
        'error_server_pattern_not_found' => 'Pattern non trovato.',
	),
	'config' => array(
		'general' => 'Generale',
		'language' => 'Linguaggio',
		...
		'tab_snmp' => 'SNMP',
		'settings_snmp' => 'Impostazioni SNMP',
		'oid_id' => 'ID',
		'oid_name' => 'Nome univoco',
		'oid_label' => 'Etichetta',
		'oid_string' => 'Stringa OID',
		'oid_conversion' => 'Stringa conversione',
		'oid_status_up' => 'Valore stato attivo',
		'oid_status_warning' => 'Valore stato attenzione',
		'oid_status_error' => 'Valore stato errore',
		'oid_string_tooltip' => 'Stringa identificativa del\' OID che verrà interrogato. Es.: .1.3.6.1.2.1.1.1.0',
		'oid_conversion_tooltip' => 'Espressione regolare da usare per visualizzare il valore ottenuto. Se non inserita verrà mostrato il valore senza alcuna alterazione.',
	...
	'snmp' => array(
		'title' => 'Parametri SNMP',
        'title_small' => 'SNMP',
		'community' => 'Community',
		'community_description' => 'Stringa identificativa',
		'version' => 'Versione',
		'version_description' => 'Versione accettata dall\'agent: 1 o 2c',
        'title_oid_standard' => 'OID Standard',
        'title_oid_custom' => 'OID Personalizzati',
        'oid' => 'Identificatore Oggetto (oid)',
        'oid_sysuptime' => 'UpTime Sistema',
        'oid_sysdescr' => 'Descrizione',
        'oid_sysobjectid' => 'Identificativo Fornitore',
        'oid_syscontact' => 'Contatto',
        'oid_sysname' => 'Nome nodo',
        'oid_syslocation' => 'Posizione',
        'oid_sysservices' => 'Servizi',
        'error_value_hostname' => 'Hostname {value} non valido.',
        'error_value_port' => 'Porta {value} non valida.',
        'error_value_version' => 'Versione {value} non valida.',
        'error_value_timeout' => 'Timeout {value} non valido.',
        'detail_title' => 'Dettagli e risultati SNMP',
        'last_value' => 'Ultimo valore ricevuto',
	),
    'common' => array(
        'day' => 'giorno',
        'days' => 'giorni',
