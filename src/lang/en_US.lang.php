...
$sm_lang = array(
	...
	'snmp' => array(
		'title' => 'SNMP parameters',
        'title_small' => 'SNMP',
		'community' => 'Community',
		'community_description' => 'Community string',
		'version' => 'Version',
		'version_description' => 'SNMP Agent version allowed: 1 or 2c',
        'title_oid_standard' => 'Standard OID',
        'title_oid_custom' => 'Custom OID',
        'oid' => 'Object Identifier (oid)',
        'oid_sysuptime' => 'System UpTime',
        'oid_sysdescr' => 'Description entity',
        'oid_sysobjectid' => 'Vendor\'s identification',
        'oid_syscontact' => 'Contact person',
        'oid_sysname' => 'Node name',
        'oid_syslocation' => 'Location',
        'oid_sysservices' => 'Services',
        'error_value_hostname' => 'Hostname {value} not valid.',
        'error_value_port' => 'Port {value} not valid.',
        'error_value_version' => 'Version {value} not valid.',
        'error_value_timeout' => 'Timeout {value} not valid.',
        'detail_title' => 'SNMP details and result',
        'last_value' => 'Last received value',
    'common' => array(
        'day' => 'day',
        'days' => 'days',
        'hour' => 'hour',
